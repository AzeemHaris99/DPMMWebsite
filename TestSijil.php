...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/sijil.css">
    ...
    <body class="appear-animate">
        ...
        <div class="page" id="top">
            ...
            <main id="main">
                ...
                <!-- Home Section -->
                <section class="home-section bg-dark-alfa-50 parallax-5" data-background="images/background/bg6.jpg" id="home">
                    <div class="container min-height-100vh d-flex align-items-center pt-100 pb-100">
                        ...
                        <div class="home-content text-start">
                            ...
                            <div class="container">
                            <h1 class="hs-line-10 uppercase mb-30 mb-xs-20 wow fadeInUpShort" data-wow-delay=".1s">Sijil Keahlian</h1>
                            <h2 class="section-title">Sila masukkan nombor kad pengenalan yang telah didaftarkan untuk memperoleh sijil keahlian anda</h2>
                            <div class="center">
                  <div class="form wow fadeInUpShort">
                  
                  <form action="sijil.php" method="post">
                      
                        <input type="text" name="search" placeholder="No. Kad Pengenalan">
                        <input class="btn btn-mod btn-large btn-round" type="submit" name="Cetak" value="Cetak Sijil">
