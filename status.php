...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `ahliKelab` WHERE CONCAT(`id`, `ic`, `namaSya`, `waktuTamat`, `STATUSAHLI`) where ic like '%$search_result%'";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="wow fadeInUpShort" data-wow-delay=".1s">
                                    <h1 class="hs-line-7 mb-20 mb-xs-10">Semakan Status Keahlian</h1>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table shopping-cart-table">
                                ...
                                <tr>
                                    ...
                                    <td colspan="4"><?php echo $row['STATUSAHLI'];?></td>
                                </tr>
                                <tr>
                                    <td colspan="4">Yuran Keahlian DPMM</td>
                                    <td colspan="4"><a href="#" target="popup" onclick="window.open('https://sandbox.senangpay.my/payment/163409246144','popup','width=600,height=1000'); return false;"><img alt="" src="https://sandbox.senangpay.my/public/img/pay.png"></a></td>
                                </tr>
                            </table>
                    </form>            
                    </div>
